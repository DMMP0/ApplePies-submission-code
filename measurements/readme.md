...
the file 'merge_benchmarks' is used to merge the benchmarks of the Hailo 8L and IMX500 into a single csv file.

The file 'produce_plot' is used to produce the figure in the paper.